...
3. Капитализация значений в левой таблице
4. Размер шрифта, положение в строке
5. Форматирование в шаблоне двухконтентном
6. Цвета?
7. Попробовать создать презентацию для каждого упражнения
